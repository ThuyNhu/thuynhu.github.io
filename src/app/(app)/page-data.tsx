...
export const features: BentoCardProps[] = [
  {
    Icon: LaughIcon,
    name: "Hi, I'm Thuy",
    description: "Welcome to my corner of the internet. Thanks for stopping by! (And actually, it's Thụy)",
  ...
  },
  {
    ...
    description: "For the past 2.5 years, I've been a backend-focused software engineer in the banking world, where I also enjoy pitching in with frontend work and actively exploring DevOps. My goal is to grow my skills and deliver reliable applications along the way!",
    href: "/",
  ...
  },
  {
    ...
    name: "Still cooking...",
    description:
      "If I weren't a software engineer, I'd be a cook. I love everything about food, from cooking it to enjoying it. And it feels really great knowing that my cooking makes people happy.",
    href: "/",
    background: <img
  ...
  },
  {
    ...
    name: "Hobbies",
    description:
      "Outside of the kitchen, I also enjoy traveling and exploring new places. I also love diving into the world of video games and board games.",
    href: "/",
